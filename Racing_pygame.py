...
def main():  # 메인 처리
    ...
    img_Aurora = pygame.image.load("C:\\Users\\win10\\Desktop\\pythonworkspace\\포트리올\\image_Racing\\Aurora.png").convert_alpha()
    img_obj = [
        None,
        pygame.image.load("C:\\Users\\win10\\Desktop\\pythonworkspace\\포트리올\\image_Racing\\Satellite.png").convert_alpha(),
        pygame.image.load("C:\\Users\\win10\\Desktop\\pythonworkspace\\포트리올\\image_Racing\\meteorite.png").convert_alpha(),
        pygame.image.load("C:\\Users\\win10\\Desktop\\pythonworkspace\\포트리올\\image_Racing\\Sirius.png").convert_alpha()
    ]
    img_car = [
    ...
    while True:
        ...
        screen.blit(img_Aurora, [board_x[BOARD - 1] - 780, sy])  # 가장 먼 오로라
        ...
        for i in range(BOARD - 1, 0, -1): #반복해서 도로의 판 그리기
            ...
            if obj_l == 9:  # 오로라
                screen.blit(img_Aurora, [ux - uw * 0.5 - 780, uy])
